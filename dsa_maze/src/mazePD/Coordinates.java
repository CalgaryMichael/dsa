...
public class Coordinates {
	private int x;		// x coordinate for a cell location (0..maze dim-1)
	private int y;		// y coordinate for a cell location (0..maze dim-1)
	private int z;		// z coordinate (level) for a cell location (0..depth-1)
	...
	*/
	...
	public Coordinates (int x, int y, int z, boolean visited) {
		setX(x);
		setY(y);
		setZ(z);
